          ...
          //   Determine the source and clean everything up
            ...
            function loadSeriesFixtures(callback) {
              ...
              that.store.keys(escapeGlob(that.seriesKey + '_*'), function handleFixtures (err, keys) {
                ...
                async.forEach(keys, function loadFixture (key, callback2) {
            ...
            return that.loadSeriesFixtures(function handleFixtures (err, fixtures) {
              // If there was an error, callback with it
              ...
              var tallerFixtures = fixtures.filter(function filterTallerFixture (fixture) {
                var i = 0;
                var len = localReqMsg.pastRequestKeys.length;
              });
